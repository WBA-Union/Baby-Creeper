...
public class BabyCreeperMod {
    ...
    public static final class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            event.enqueueWork(() -> EntityRenderers.register(ModEntities.BABY_CREEPER.get(),
                    (EntityRendererProvider.Context context) -> new BabyCreeperRenderer(context, new BabyCreeperModel<>(BabyCreeperModel.createBodyLayer().bakeRoot()))));
        }
    }
}
