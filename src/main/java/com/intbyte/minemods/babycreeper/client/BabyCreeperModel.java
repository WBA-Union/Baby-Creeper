...
public class BabyCreeperModel<T extends BabyCreeperEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("head", CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(-4.0F, -3.0F + yOffset, -4.0F, 8.0F, 7.0F, 8.0F), PartPose.offset(0.0F, 6.0F, 0.0F));
        root.addOrReplaceChild("body", CubeListBuilder.create()
                .texOffs(16, 16)
                .addBox(-3.0F, 4.0F + yOffset, -2.0F, 6.0F, 8.0F, 4.0F), PartPose.offset(0.0F, 6.0F, 0.0F));
        root.addOrReplaceChild("leg1", CubeListBuilder.create()
                .texOffs(0, 16)
                .addBox(-2.0F, 3.0F, -3.0F, legX, 3.0F, legZ), PartPose.offset(-2.0F, 18.0F, 4.0F));
        root.addOrReplaceChild("leg2", CubeListBuilder.create()
                .texOffs(0, 16)
                .addBox(0.0F, 3.0F, -3.0F, legX, 3.0F, legZ), PartPose.offset(2.0F, 18.0F, 4.0F));
        root.addOrReplaceChild("leg3", CubeListBuilder.create()
                .texOffs(0, 16)
                .addBox(-2.0F, 3.0F, -1.0F, legX, 3.0F, legZ), PartPose.offset(-2.0F, 18.0F, -4.0F));
        root.addOrReplaceChild("leg4", CubeListBuilder.create()
                .texOffs(0, 16)
                .addBox(0.0F, 3.0F, -1.0F, legX, 3.0F, legZ), PartPose.offset(2.0F, 18.0F, -4.0F));
