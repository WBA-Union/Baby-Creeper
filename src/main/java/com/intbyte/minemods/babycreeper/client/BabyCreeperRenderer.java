...
public class BabyCreeperRenderer extends MobRenderer<BabyCreeperEntity, BabyCreeperModel<BabyCreeperEntity>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(BabyCreeperMod.MOD_ID, "textures/entity/baby_creeper.png");

    public BabyCreeperRenderer(EntityRendererProvider.Context context, BabyCreeperModel<BabyCreeperEntity> model) {
